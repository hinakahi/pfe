...
@if(!$periodeRenouvellement)
    <div class="alert alert-warning d-flex align-items-center gap-2 mb-4">
        ...
        <div><strong>Période fermée</strong> — Les demandes de renouvellement ne sont pas disponibles pour le moment.</div>
    </div>
@elseif(!$maChambre)
    ...
    <div class="row g-3 mb-3">
        <div class="col-md-6">
            <div class="card border-0 shadow-sm h-100 carte-toggle active-carte"
                 ...
                 onclick="toggleSection('section-demande', this)">
                <div class="card-body d-flex align-items-center gap-3">
                    <div class="rounded-circle d-flex align-items-center justify-content-center" style="width:48px;height:48px;background:#e6f7ec;">
                        <i class="bi bi-arrow-repeat" style="font-size:1.4rem;color:#28a745;"></i>
                    </div>
                    <div class="flex-grow-1">
                        <div class="fw-bold">Faire une demande</div>
                        <div class="text-muted small">
                            @if($demandeEnCours)
                                {{ $demandeEnCours->statut === 'en_attente' ? 'Demande en attente' : 'Demande validée' }}
                            @else
                                Renouveler ma chambre
                            @endif
                        </div>
                    </div>
                </div>
        ...
        <div class="col-md-6">
            <div class="card border-0 shadow-sm h-100 carte-toggle"
                 ...
                 onclick="toggleSection('section-historique', this)">
                <div class="card-body d-flex align-items-center gap-3">
                    <div class="rounded-circle d-flex align-items-center justify-content-center" style="width:48px;height:48px;background:#fff3e8;">
                        <i class="bi bi-clock-history" style="font-size:1.4rem;color:#fd7e14;"></i>
                    </div>
                    <div class="flex-grow-1">
                        <div class="fw-bold">Mes demandes de renouvellement</div>
                        <div class="text-muted small">{{ $demandesRenouvellement->count() }} demande(s)</div>
                    </div>
                </div>
            </div>
        </div>
...
{{-- Section : Faire une demande --}}
<div id="section-demande" class="mb-4">
    <div class="card border-0 shadow-sm mb-3">
        <div class="card-body">
            ...
            @elseif($periodeRenouvellement && $maChambre)
            ...
            @else
                <div class="text-muted small mb-0">Aucune action disponible pour le moment.</div>
            @endif
        </div>
    </div>
</div>

{{-- Section : Mes demandes de renouvellement (dernière demande + historique) --}}
<div id="section-historique" style="display:none;" class="mb-4">
...
function toggleSection(id, carte) {
    ...
    document.querySelectorAll('#section-demande, #section-historique').forEach(s => s.style.display = 'none');
